...
const STRINGS = {
  en: {
    ...
    bookingConfirmed: "Your request has been received. Booking ID: {bookingId}\nWe're searching for the nearest ambulance. We'll send driver details as soon as one confirms.\nIf this is urgent, call us now: {phone}",
  ...
  hi: {
    ...
    bookingConfirmed: 'आपका अनुरोध मिल गया है। बुकिंग आईडी: {bookingId}\nहम आपके नज़दीक की एम्बुलेंस ढूंढ रहे हैं। ड्राइवर के पुष्टि करते ही हम उनकी जानकारी भेज देंगे।\nयह तुरंत ज़रूरी हो तो अभी कॉल करें: {phone}',
  ...
  kn: {
    ...
    bookingConfirmed: 'ನಿಮ್ಮ ವಿನಂತಿ ಸ್ವೀಕರಿಸಲಾಗಿದೆ. ಬುಕಿಂಗ್ ಐಡಿ: {bookingId}\nಹತ್ತಿರದ ಆಂಬ್ಯುಲೆನ್ಸ್ ಹುಡುಕುತ್ತಿದ್ದೇವೆ. ಚಾಲಕರು ಒಪ್ಪಿದ ತಕ್ಷಣ ಅವರ ವಿವರಗಳನ್ನು ಕಳುಹಿಸುತ್ತೇವೆ.\nತುರ್ತಾಗಿದ್ದರೆ ಈಗಲೇ ಕರೆ ಮಾಡಿ: {phone}',
  ...
  te: {
    ...
    bookingConfirmed: 'మీ అభ్యర్థన అందింది. బుకింగ్ ఐడీ: {bookingId}\nసమీపంలోని అంబులెన్స్ కోసం వెతుకుతున్నాము. డ్రైవర్ నిర్ధారించిన వెంటనే వారి వివరాలు పంపుతాము.\nఇది అత్యవసరమైతే వెంటనే కాల్ చేయండి: {phone}',
