...
const tripCallEventRoutes = require('./routes/tripCallEvents');
const geofenceEventRoutes = require('./routes/geofenceEvents');
...
app.use('/api/trip-call-events', tripCallEventRoutes);
